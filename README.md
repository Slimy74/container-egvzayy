...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-egvzayy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-egvzayy.containers.anotherwebservice.com/
...
```
git clone git@github.com:Slimy74/container-egvzayy.git
cd container-egvzayy
```
...
```
docker attach container-egvzayy
```
